...
?>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      $sql = "select iniciales, nombre, apellido from agentes where iniciales = '".$Agente."' and password=md5('".$Clave."')";
      ...
      ?>
          ...
          <section class="">
                ...
                <div class="content-panel">
                  <h4><i class="fa fa-angle-right"></i>Comisiones <?php echo $row["nombre"] . " ". $row["apellido"] . "(" . $row["iniciales"] .")"; ?></h4>
                    <?php
                      if ($Filas > 0 )
                      {
