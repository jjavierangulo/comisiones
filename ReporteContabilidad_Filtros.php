         ...
         <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Reporte de comisiones Contabilidad</h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                     ...
                     <form class="form-horizontal style-form" method="get">
                        ...
                        <button type="button" class="btn btn-primary" onclick="MostrarContabilidad()">Mostrar Reporte</button>
                     </form>
                  </div>   
               </div>
          	</div><!-- col-lg-12-->      	
