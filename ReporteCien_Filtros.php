                ...
                <div class="form-panel">
                   ...
                   <form class="form-horizontal style-form" method="get">
                      <div class="form-group">
                         ...
                         <div class="col-sm-10">
                            <input type="text" class="form-control" id="Usuario" pattern="[A-Z]+" maxlength="6"  required="" onkeyup = "this.value=this.value.toUpperCase()" onkeypress="return soloLetras(event)">
                         </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <?php 
                            foreach ($TipoCliente as $Nombre) {
                              ...
                              echo '<input type="checkbox" name="Cliente" class="hidden" value="'. utf8_encode($Nombre).'" /></span>';
                     ...
                     <button type="button" class="btn btn-primary" onclick="MostrarContenidoCien()">Mostrar Reporte</button>
                   </form>
                </div>   
             </div>
        	</div><!-- col-lg-12-->      	
